...
use Drupal\commerce_option\CommerceOptionInterface;
use Drupal\user\UserInterface;

/**
 * Defines the Commerce Option entity.
 *
 ...
 *       "edit" = "Drupal\commerce_option\Form\CommerceOptionForm",
 *       "delete" = "Drupal\commerce_option\Form\CommerceOptionDeleteForm",
 *     },
 *     "access" = "Drupal\commerce_option\CommerceOptionAccessControlHandler",
 *     "route_provider" = {
 *       "html" = "Drupal\commerce_option\CommerceOptionHtmlRouteProvider",
 *     },
 *   },
 *   base_table = "commerce_option",
 *   admin_permission = "administer commerce option entities",
 *   entity_keys = {
 *     "id" = "id",
 *     "bundle" = "type",
 *     "label" = "name",
...
class CommerceOption extends ContentEntityBase implements CommerceOptionInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['user_id'] = BaseFieldDefinition::create('entity_reference')
      ...
      ->setDescription(t('The user ID of author of the Commerce Option entity.'))
    ...
    $fields['name'] = BaseFieldDefinition::create('string')
      ->setLabel(t('Name'))
      ->setDescription(t('The name of the Commerce Option entity.'))
      ->setSettings(array(
        'max_length' => 50,
        'text_processing' => 0,
      ))
    ...
    $fields['status'] = BaseFieldDefinition::create('boolean')
      ...
      ->setDescription(t('A boolean indicating whether the Commerce Option is published.'))
      ->setDefaultValue(TRUE);

    $fields['langcode'] = BaseFieldDefinition::create('language')
      ->setLabel(t('Language code'))
      ->setDescription(t('The language code for the Commerce Option entity.'))
      ->setDisplayOptions('form', array(
